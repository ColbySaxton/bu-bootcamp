...
public class GradeAnalyzerTest {
    ...
    @Test
    void calculateAverage_handlesMinAndMaxIntValues() {
        ArrayList<Integer> scores = new ArrayList<>(Arrays.asList(Integer.MAX_VALUE, Integer.MIN_VALUE)); 
        assertEquals(-0.5, GradeAnalyzer.calculateAverage(scores)); 
    }
}
